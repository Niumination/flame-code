...
export const DEFAULT_THEME_ID = "flame-code-default";
...
const STORE_PATH = "flame-code-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "flame-code://prefs-changed";
...
const KEYS_CHANGED_EVENT = "flame-code://ai-keys-changed";
